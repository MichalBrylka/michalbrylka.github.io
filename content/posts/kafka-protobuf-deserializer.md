...
Moreover, my synchronous version is *only* slightly (*"negligibly"*) faster than my async counterpart. But since there is really no point of using async here - synchronous deserializer might me our variant of choice. 
